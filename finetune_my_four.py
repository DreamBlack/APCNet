...
import os
# python finetune_my_four.py --folding_decoder=0 --tensorboardDir=/home/dream/study/codes/PCCompletion/best_four_exp/pix3d/table/tensorboard --checkpointDir=/home/dream/study/codes/PCCompletion/best_four_exp/pix3d/table/checkpoint --workers=16 --batchSize=16 --D_choose=0 --Rep_choose=1 --class_choice=Table --attention_encoder=1 --step_size=40 --gamma=0.2 --alpha=0.1 --loss_emd=1 --pointnetplus_encoder=1 --learning_rate=0.00004  --niter=151 --netG=/home/dream/study/codes/PCCompletion/best_four_exp/table/checkpoint/point_netG150.pth
    ...
    if opt.D_choose == 1:
        ...
        for epoch in range(resume_epoch, opt.niter):
            for i, data in enumerate(dataloader, 0):
                ...
                incomplete, gt, image,pcl_2025,img_path= data
