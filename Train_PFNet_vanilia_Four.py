...
parser.add_argument('--four', type=int, default=1, help='0 not use D-net,1 use D-net')
parser.add_argument('--netG', default='', help="path to netG (to continue training)")
parser.add_argument('--netD', default='', help="path to netD (to continue training)")
parser.add_argument('--expdir', default='/home/dream/study/codes/PCCompletion/best_four_exp/pfnet/vanilia/lamp', help="path to netD (to continue training)")
...
dset = MyDataset(classification=True, class_choice=opt.class_choice, split='train', four_data=opt.four)
assert dset
